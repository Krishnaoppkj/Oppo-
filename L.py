...
bot = telebot.TeleBot('6647590604:AAG-iNFCBLCf1rEOPVQRxnthyeCrXa52CPI')
...
Buy From :- @KRISHNAVVIPMODS 
Official Channel :- @KRISHNAVVIPMODS 
'''
...
3. MAKE SURE YOU JOINED @KRISHNAVVIPMODS  OTHERWISE NOT WORK
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "Welcome To KRISHNA  || VIP Please choose an option:", reply_markup=markup)
...
def handle_resellership(message):
    bot.reply_to(message, "Contact @KRISHNAVVIPMODS   for reseller ship.")
